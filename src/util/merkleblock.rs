...
//!
//! ```rust
//! use litcoinlib::hash_types::Txid;
//! use litcoinlib::hashes::hex::FromHex;
//! use litcoinlib::{Block, MerkleBlock};
//!
...
//! let mb: MerkleBlock = litcoinlib::consensus::deserialize(&mb_bytes).unwrap();
//!
...
impl PartialMerkleTree {
    ...
    /// use litcoinlib::hash_types::Txid;
    /// use litcoinlib::hashes::hex::FromHex;
    /// use litcoinlib::util::merkleblock::PartialMerkleTree;
    ///
    /// // Block 80000
    /// let txids: Vec<Txid> = [
...
impl MerkleBlock {
    ...
    /// let block: Block = litcoinlib::consensus::deserialize(&block_bytes).unwrap();
    ///

...
//!
//! ```rust
//! use litecoinlib::hash_types::Txid;
//! use litecoinlib::hashes::hex::FromHex;
//! use litecoinlib::{Block, MerkleBlock};
//!
...
//! let mb: MerkleBlock = litecoinlib::consensus::deserialize(&mb_bytes).unwrap();
//!
...
impl MerkleBlock {
    ...
    /// let block: Block = litecoinlib::consensus::deserialize(&block_bytes).unwrap();
    ///
...
impl PartialMerkleTree {
    ...
    /// use litecoinlib::hash_types::Txid;
    /// use litecoinlib::hashes::hex::FromHex;
    /// use litecoinlib::merkle_tree::{MerkleBlock, PartialMerkleTree};
    ///
    /// // Block 80000
    /// let txids: Vec<Txid> = [

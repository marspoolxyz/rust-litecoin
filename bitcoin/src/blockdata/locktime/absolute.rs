...
/// # Examples
/// ```
/// # use litecoinlib::absolute::{LockTime, LockTime::*};
...
pub enum LockTime {
    ...
    /// # Examples
    /// ```rust
    /// use litecoinlib::absolute::LockTime;
    ///
...
impl LockTime {
    ...
    /// # Examples
    /// ```no_run
    /// # use litecoinlib::absolute::{LockTime, Height, Time};
...
impl Height {
    ...
    /// # Examples
    /// ```rust
    /// use litecoinlib::locktime::absolute::Height;
    ///
    /// let h: u32 = 741521;
...
impl Time {
    ...
    /// # Examples
    /// ```rust
    /// use litecoinlib::locktime::absolute::Time;
    ///
